...
class CareGiverKinAdapter(
    private var entryList: MutableList<CareGiverNextOfKin>,
    private val context: Context,
) : RecyclerView.Adapter<CareGiverKinAdapter.Pager2ViewHolder>() {
    ...
    fun addItem(careGiver: CareGiverNextOfKin) {
        //
    ...
    fun removeItem(careGiver: CareGiverNextOfKin) {
        //
        if (entryList.contains(careGiver)) {
